...
{
    public partial class UserControlProductAdminView : UserControl
    {
        public UserControlProductAdminView(int productID, double productPrice, int product_Stock, string productColor, string productSize, string productDescription)
        {
            InitializeComponent();
            ID = productID;
            Price = productPrice;
